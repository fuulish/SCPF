...
FixStyle(scpf,FixSCPF)    // This registers this fix class with LAMMPS.

#else
*/

#ifndef LMP_FIX_SCPF_H
#define LMP_FIX_SCPF_H
...
class FixSCPF : public FixMinimize {
 public:
  ...
  void setup_post_force(int);
  // void setup_pre_force_respa(int, int);
  // void pre_force_respa(int, int, int);

  void min_setup_pre_force(int);
  void min_setup_post_force(int);
