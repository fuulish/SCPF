...
FixStyle(scpf/hftn,FixSCPFHFTN)    // This registers this fix class with LAMMPS.

#else

#ifndef LMP_FIX_SCPF_HFTN_H
#define LMP_FIX_SCPF_HFTN_H
...
class FixSCPFHFTN : public FixSCPF
{
  public:

  FixSCPFHFTN(class LAMMPS *, int, char **);
  ~FixSCPFHFTN();
  void init();
  void setup_style();
  void reset_vectors();
